...
public class TerminalActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvTerminal = (TextView) findViewById(R.id.textView);
        /*
    ...
    public void onBluetoothSerialRead(String message) {
        ...
        //      message));
        //tvTerminal.setText(getString(R.string.terminal_message_template,
        //        bluetoothSerial.getConnectedDeviceName(),
        //        message));

        //String strColor = "#FF0000";
        //tvTerminal.setTextColor(Color.parseColor(strColor));
        //String string = String.format("\n<PM2.5>초미세먼지\n%3d\n\n<PM10>미세먼지\n%3d\n\n<온도>\n%2d", 211, 34, 11);
        tvTerminal.setText(message);
